...
export const Technologies = () => {
  return (
    <section className="container py-12">
      <h2 className="font-aloevera mb-6 text-center text-6xl font-semibold italic">
      ...
      <div className="grid grid-cols-2 gap-4">
        {TECHNOLOGIES.map((item) => (
          <div
            ...
            key={item.id}
          >
            <div className="text-secondary-foreground relative z-10 flex h-full flex-col justify-between p-12">
              <div>
